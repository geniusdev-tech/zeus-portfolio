...
const ptBR = {
  ...
  philosophy: {
    ...
    items: [
      ...
      {
        n: '02',
        title: 'Eficiência sem desperdício',
        text: 'Use o menor conjunto confiável de componentes que resolva o problema sem adicionar ruído.',
      },
      {
        n: '03',
        title: 'Engenharia orientada a resultado',
        text: 'Se não melhora confiabilidade, velocidade ou clareza, não entra em produção.',
      },
    ],
  },
  aiChat: {
